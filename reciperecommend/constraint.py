...
def nutritional_constraints(yum, age, weight, height, gender, activity_level):
    ...
    nutrition_list=['ENERC_KJ', 'PROCNT', 'CHOCDF', 'FIBTG', 'FAT', 'CA', 'FE', 'MG', 'P', 'K','NA', 'ZN', 'MN', 'SE', 'VITA_RAE', 'TOCPHA', 'VITC', 'RIBF', 'NIA', 'VITB6A', 'BITB12', 'CHOLN', 'VITK', 'FOL']
    unit_ratio=[1, 1, 1, 1, 1, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000000, 0.001, 1000, 1000, 1000, 1000, 1000, 1000000, 1000, 1000000, 1000000]
